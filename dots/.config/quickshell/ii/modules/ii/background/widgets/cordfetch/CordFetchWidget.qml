...
// cordcraft's fetch readout. Identical machinery to ultrafetch -- the logo
// frames come from ultrafetch-build the same way -- but its own config entry
// so the two rices can carry different art and different placement.
